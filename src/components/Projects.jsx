  ...
  const projects = [
    {
      ...
      description: "A full-stack e-commerce platform with user authentication, payment integration, and admin dashboard. Features include product catalog, shopping cart, and order management.",
    ...
    },
    {
      ...
      description: "A responsive weather dashboard with location-based forecasts, interactive charts, and weather alerts. Includes 7-day forecasts and weather maps.",
    ...
    },
    {
      id: 5,
      title: "AI Chat Bot",
      description: "An intelligent chatbot with natural language processing, context awareness, and multi-language support for customer service automation.",
    ...
    },
    {
      ...
      description: "A responsive portfolio website with smooth animations, dark/light mode toggle, and interactive project showcase.",
  ...
  return (
    <section className="min-h-screen bg-black py-20 px-4" id='projects'>
      <div className="max-w-7xl mx-auto">
        ...
        {/* Projects Grid */}
        <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 space-x-4 space-y-4">
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="relative aspect-video overflow-hidden">
                ...
                <div className={`absolute inset-0 bg-black/80 flex items-center justify-center space-x-6 transition-all duration-300 ${
